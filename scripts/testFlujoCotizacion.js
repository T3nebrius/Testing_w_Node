...
module.exports = async function testFormSubmission(page) {
    ...
    try {
        ...
        console.log("\033[32m- ERROR EN CLICK FICHA CLIENTE. -\033[0m");
    }
    ...
    try {
        ...
        console.log("- Click en el elemento 'Cotización en Sala' realizado. -");
    } catch (err){
        console.log("\033[32m- ERROR click en el elemento 'Cotización en Sala'... -\033[0m");
    }
    ...
    try {
        ...
        console.log("\033[32m- ERROR el clic en el botón 'Agregar Producto'... -\033[0m");
    }
    ...
    try {
        ...
        console.log("\033[32m- ERROR EN clic en el botón 'Guardar'... -\033[0m");
    }
    ...
    try {
        ...
        console.log("- ERROR: Simulando el click en el botón 'Debe evaluar cliente'... -");
    }
    ...
    try {
        ...
        console.log("- ERROR: SIMULANDO MODAL 'Evaluacion Cliente'... -");
    }


    /* SELECCIONA RAZON DE COMPRA */
    console.log("- simulando selector 'Razón de compra'... -");
    try {
        ...
        console.log("- ERROR: simulando selector 'Razón de compra'... -");
    }

    /* llenado textarea evaluacion*/
    ...
    try{
        ...
        console.log("- ERROR: Llenando el campo de texto área ... -");
    }
    
    /* click guardar evaluacion */
    console.log("- Click en el botón 'Guardar Evaluación' -");
    try {
        await page.click('#btn_guardar_evaluacion');
        console.log("- Click en el botón 'Guardar Evaluación' realizado exitosamente. -");
    }catch(err){
        console.log("- ERROR: Click en el botón 'Guardar Evaluación'-");
    }
    ...
    try {
        ...
        console.log("- ERROR: Esperando alerta... -");
    }
